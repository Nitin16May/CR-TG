		...
		<div>
			<div className='full-screen-div'>
				<div className='overlay-div'>
					...
					<div className='button-container'>
						<button className='button' onClick={showStudentLogin}>
							Student Login
						</button>
						<button className='button' onClick={showFacultyLogin}>
							Faculty Login
						</button>
						<button className='button' onClick={showAdminLogin}>
							Admin Login
						</button>
					</div>
				</div>
			...
			<div id='studentLogin' className='hidden-overlay'>
				<div className='everythinghidden'>
					<button className='hiddenoverlaybutton' onClick={backToNormal} style={{ marginLeft: '0px' }}>
						Back
					</button>
					<p>
						Hey {UserType}, <br></br> Please Login to continue
					</p>
